...
export abstract class AdminAbstract {
   ...
   * @private
   */
  private parseManyOrFirstArgs(args: FindManyAdminArgs | FindFirstAdminArgs) {
  ...
  findFirst(args: FindFirstAdminArgs): PrismaPromise<Admin | null> {
    ...
    return this.db.admin.findFirst({ include, where, orderBy, skip, take, distinct, cursor });
  }
  ...
  findMany(args: FindManyAdminArgs): PrismaPromise<Admin[]> {
    const { include, where, orderBy, skip, take, distinct, cursor } = this.parseManyOrFirstArgs(args);
    return this.db.admin.findMany({ include, where, orderBy, skip, take, distinct, cursor });
  }
  ...
  upsert(args: UpsertOneAdminArgs): PrismaPromise<Admin> {
    ...
    return this.db.admin.upsert({ include, where, create, update });
  }
